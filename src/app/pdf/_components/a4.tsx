...
export function A4(props: ComponentProps<"div">) {
  return (
    <div
      className="font-cv w-[210mm] h-[297mm] box-border mx-auto bg-white overflow-hidden flex flex-col text-black print:mx-0 print:my-0 print:p-4 print:w-screen print:rounded-none print:shadow-none md:my-10 md:rounded-md md:shadow-2xl"
      {...props}
    >
      {props.children}
    </div>
